...
import config
config_path = os.path.join(SCRIPT_DIR, "01_bilibili_crawler_config.py")
...
# 用仓库根目录算绝对路径，避免 chdir 后读到错误文件
import csv as csv_module
_bilibili_csv_dir = os.path.join(FINAL_PROJECT_ROOT, "00_output", "01_Raw_data", "02_Bilibili", "csv")
